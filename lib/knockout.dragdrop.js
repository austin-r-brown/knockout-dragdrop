...
(function (factory) {
    ...
    Draggable.prototype.drop = function (event) {
        ...
        var dropZoneElement = getClosest(event.data, '.drop-zone');
        ...
        dragZone: {
            init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                element.addEventListener('selectstart', function (event) {
                    if (!event.data.tagName || event.data.tagName.toLowerCase() !== 'input' && event.data.tagName.toLowerCase() !== 'textarea') {
                        event.preventDefault();
                        event.stopPropagation();
                        return false;
                    }
                ...
                function beginEvent(downEvent) {
                    ...
                    function startDragging(startEvent) {
                        ...
                        function finishEvent(upEvent) {
                            ...
                            cloneEvent.data = document.elementFromPoint(
                    ...
                    function onMouseMoveStartDrag(event) {
                        if (event.data.tagName && event.data.tagName.toLowerCase() === 'input') {
                            return true;
                        }
